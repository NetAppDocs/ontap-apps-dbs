...
image::../media/vmsc_mcc_overview.png[vMSC diagram with MCC,width=624,height=485]
...
image::../media/vmsc_smas_mediator.png[vMSC diagram with MSas and mediator,width=624]
