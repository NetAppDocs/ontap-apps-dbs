---
sidebar: sidebar
permalink: oracle/oracle-asar2-storage-san-config-asmru.html
keywords: ontap, thin provisioning, oracle, ASMRU, ASA r2
summary: ASM Reclamation Utility with ONTAP zero-block detection on ASA r2
searchtitle: ASM Reclamation Utility (ASMRU) with ONTAP on ASA r2
---
...
Key ASMRU considerations with ASA r2 ONTAP:
