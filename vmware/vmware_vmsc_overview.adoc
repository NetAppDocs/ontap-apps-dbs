...
Refer to https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability/creating-and-using-vsphere-ha-clusters/creating-a-vsphere-ha-cluster/create-vsphere-ha-cluster.html[Create a vSphere HA Cluster in the vSphere Client] to configure vCenter HA.
...
If you want more information about the design guidelines for vSphere Metro Storage Cluster, you can refer to the folowing solution guides:

* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html[VMware vSphere Metro Storage Cluster with SnapMirror active sync]

* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vcf-vmsc-mgmt-mcc.html[Configure a stretch cluster for a VCF management domain using MetroCluster]

* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vcf-vmsc-viwld-mcc.html[Configure a stretch cluster for a VCF workload domain using MetroCluster]
