...
image:vvols-deploy-3.png[role="thumb" Provision datastore wizard]

*** Click _finish_

image:vvols-deploy-4.png[role="thumb" Provision datastore wizard]
...
image:vvols-deploy-5.png[role="thumb" Provision datastore wizard]

*** Select the SVM and click _next_.

image:vvols-deploy-5a.png[role="thumb" Provision datastore wizard]
...
image:vvols-deploy-6.png[role="thumb" Provision datastore wizard]

image:vvols-deploy-7.png[role="thumb" Provision datastore wizard]

*** Click _finish_

image:vvols-deploy-8.png[role="thumb" Provision datastore wizard]

*** You can see the assigned volumes in the ONTAP tools menu of the configure tab for the datastore.

image:vvols-deploy-9.png[role="thumb" Provision datastore wizard]
