...
summary: Rapid Oracle database recovery with snapshots
searchtitle: Rapid Oracle database recovery with snapshots
---
= SnapRestore
:hardbreaks:
:nofooter:
...
* Individual objects on AFF systems and AFF/ASA LUNs can be restored in seconds, whether it is a 2TB LUN or a 4KB file.
* An AFF volume or consistency group can be restored in seconds, whether it is 10GB or 100TB of data.
