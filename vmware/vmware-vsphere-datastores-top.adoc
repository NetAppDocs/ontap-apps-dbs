...
keywords: vSphere, datastore, VMFS, FC, NVMe/FC, iSCSI, NFS, vVols
...
^2^ Datastores using NVMe-oF and NFS v4.1 require vSphere replication. Array-based replication is not supported by SRM.
