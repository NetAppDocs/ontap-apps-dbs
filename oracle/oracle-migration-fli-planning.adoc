...
searchtitle: Oracle migration with FLI - planning
---
...
[.lead]
The procedures to migrate SAN resources using FLI are documented in NetApp https://docs.netapp.com/us-en/ontap-fli/index.html[ONTAP Foreign LUN Import Documentation^].
