...
[.lead]
Instead of using SQL Server always on availability group or replication feature, you might want to consider ONTAP SnapMirror technology to replicate data at storage layer for disaster recovery solution. 
