...
vVols requires the use ONTAP tools for VMware vSphere which functions as the VASA Provider for ONTAP. Refer to link:vmware-vvols-overview.html[VMware vSphere Virtual Volumes (vVols) with ONTAP] for vVols best practices.
