...
[NOTE]
====
* Oracle databases, NVFAIL should be enabled on all LUNs hosting critical components (datafiles, redo logs, control files). 
* On AFF systems, NVFAIL operates at volume layer and applies to all contained data.
* On ASAr2, NVFAIL operates at the LUN or storage unit layer.
====