...
3+e|*NFS Settings*
|newSyncInterval
|If you are not using the vSphere CSI for Kubernetes, set per https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html[VMware KB 415074^] 
|No
|Net.TcpipHeapSize
