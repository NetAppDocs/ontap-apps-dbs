...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four] Prepare the appliance for vVols (optional)

[role="quick-margin-list"]
* [ ] To use vVols, you must first https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/manage/enable-services.html[edit the appliance settings and enable the VASA service]. At the same time, complete the following step.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five] Certificates
