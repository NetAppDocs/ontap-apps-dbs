...
summary: Oracle and TCP/IP and ethernet configuration on ASA r2 systems
searchtitle: TCP/IP and ethernet configuration for Oracle databases with ASA r2
---
...
[.lead]
Many Oracle on ASA r2 ONTAP customers use ethernet, the network protocol of iSCSI, NVMe/TCP, and especially the cloud.
