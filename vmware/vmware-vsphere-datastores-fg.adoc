...
summary: This page describes the best practices for implementing NetApp ONTAP FlexGroup volumes in a VMware vSphere environment.
---
...
Learn more about FlexGroup volumes in https://docs.netapp.com/us-en/ontap-technical-reports/nas-containers.html[FlexCache and FlexGroup volume technical reports].
