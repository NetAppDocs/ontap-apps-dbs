...
*** Now you can create VM storage policies from the _Policies and Profiles_ menu in the vCenter UI. It's that easy!
...
To automate storage provisioning with policy based management, we need to create VM storage policies that map to the desired storage capabilities.
