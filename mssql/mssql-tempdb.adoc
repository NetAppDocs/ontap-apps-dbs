...
[.lead]
Tempdb database can be heavily utilized. In addition to optimal placement of user database files, alter tempdb  datafiles to reduce allocation contention
