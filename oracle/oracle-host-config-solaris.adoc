...
searchtitle: Oracle databases with Solaris
---
= Solaris
...
. Partition the LUNs and verify that they are properly aligned. See link:oracle-notes-wafl-alignment-verification.html[WAFL Alignment] for instructions on how to directly test and confirm alignment.
