...
searchtitle: LUN Alignment for Oracle database I/O
---
= LUN Alignment
:hardbreaks:
:nofooter:
...
Alignment in Solaris environments is more complicated. Refer to https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_identify_unaligned_IO_on_LUNs[How to identify unaligned IO on LUNs] for more information.
