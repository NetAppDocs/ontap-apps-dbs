...
[.lead]
Designing database file placement is important during initial deployment stage. This helps in performance, space management, backup and restore time based on your business need.
