...
* As mentioned in link:vmware-vsphere-settings.html[settings], if you are not using the vSphere CSI for Kubernetes, you should set the newSyncInterval per https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html[VMware KB 415074^] 
