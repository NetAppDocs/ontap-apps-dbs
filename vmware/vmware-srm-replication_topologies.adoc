...
For the latest information about SnapMirror and SnapVault for ONTAP 9, see https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf[TR-4015 SnapMirror Configuration Best Practice Guide for ONTAP 9.^]
